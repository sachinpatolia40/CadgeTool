...
const featureProductList = [
    ...
    },
    {
        ...
        image: `${import.meta.env.BASE_URL}Carbide-Drills-thumbnail.png`
    },
    {
    ...
    },
    {
        title: 'Thread Mills',
        description: 'Precision tools for intricate operations',
        image: `${import.meta.env.BASE_URL}Thread-Mills-thumbnail.png`
    }
]
                ...
                <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
                    {featureProductList.map((product, index) => (
                        <div key={index} className="bg-white rounded-lg shadow-md overflow-hidden">
                            <img src={product.image} alt={product.title} className="md:h-64 w-full object-cover" />
                            <div className="p-6">
